 ...
 * Breadcrumb themeing
 */
function writlarge_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
 ...
 * Node preprocessing
 */
function writlarge_preprocess_node(&$vars) {
 ...
 * Page preprocessing
 */
function writlarge_commons_preprocess_page(&$vars) {
 ...
 */
function writlarge_preprocess_comment(&$vars) {
  global $user;
 ...
 */
function writlarge_preprocess_user_profile_item(&$vars) {
 ...
 */
function writlarge_shoutbox_post($shout, $links = array(), $alter_row_color=TRUE) {
  global $user;
...
function writlarge_item_list($items = array(), $title = NULL, $type = 'ul', $attributes = NULL) {
...
function writlarge_preprocess_block($variables) {
